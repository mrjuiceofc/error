...
async function isAllowed(uid) {
    ...
    if (contactsOnly && contacts.includes(uid)) {
        ...
        if (!warned.includes(uid)) {
            client.sendMessage(uid, 'API limit was reached so Mr Juice had to disable the me for general use. I require cloud servers to live on and power my links to OpenAI which is why I am not free. If you want to get added to the whitelist, please contact my author. Thank you all for your support.')
            warned.push(uid)
